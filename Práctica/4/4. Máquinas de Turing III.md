...
Tenemos una proposición del estilo $p \rightarrow q$, donde p: $HP \in R$ y q: $L_u \in R$. Para probar que esto es falso, se puede asumir que p es verdadero y luego demostrar que q es falso.
